    ...
    <b-colxx xxs="12" md="10" class="mx-auto my-auto">
      <b-card class="auth-card" no-body>
        <div class="position-relative image-side">
          <p class="text-white h2">Đăng nhập</p>
          <p class="white mb-0">
          ...
          >
            ...
            >
              ...
              <b-form-invalid-feedback v-if="!$v.form.password.required"
                >Mời nhập email</b-form-invalid-feedback
              >
              <b-form-invalid-feedback
                v-else-if="
                  !$v.form.password.minLength || !$v.form.password.maxLength
                "
                >Mât khẩu ít nhất 4 kí tự</b-form-invalid-feedback
              >
              <p class="text-red" style="padding: 20px; color: red" v-if="errorMess">{{ errorMess }}</p>
            </b-form-group>
            <div class="d-flex justify-content-between align-items-center">
              <router-link tag="a" to="/user/forgot-password" style="padding: 10px">Quên mật khẩu?</router-link>
              <b-button
                type="submit"
                variant="primary"
                size="lg"
    ...
    async formSubmit() {
      ...
      if (!this.$v.form.$anyError) {
        try {
          ...
          if (error) {
            this.errorMess = "Mật khẩu hoặc tài khoản không chính xác";
          }
        }
      }
    }
