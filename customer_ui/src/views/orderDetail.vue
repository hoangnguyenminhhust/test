  ...
  <v-main style="background-color: #ECEFF1">
    <v-container>
      ...
      <v-row>
        ...
        >
          <v-card elevation="0">
            <v-card-title>Chi tiết hoá đơn</v-card-title>
            <v-form
              lazy-validation
              style="padding: 20px"
            >
...
export default {
  ...
  async created() {
    ...
    Promise.all([await this.$store.dispatch('order/getOrderDetail', {
    ...
    if (this.user) {
      this.customer.fullname = this.order.customer.fullname;
      this.customer.phone = this.order.customer.phone;
      this.customer.email = this.order.customer.email;
      this.customer.province = this.order.customer.province;
      this.customer.district = this.order.customer.district;
      this.customer.ward = this.order.customer.ward;
      this.customer.address = this.order.customer.address;
    }
  },
  methods: {
    setupEventListener() {
